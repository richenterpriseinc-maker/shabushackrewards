        ...
        >
          <Card className="border-primary/20">
            <CardHeader className="text-center space-y-2">
              <CardTitle className="font-display text-3xl tracking-wide">Welcome Back</CardTitle>
              <p className="text-muted-foreground">Sign in to access your rewards, punch card, and exclusive deals.</p>
            </CardHeader>
